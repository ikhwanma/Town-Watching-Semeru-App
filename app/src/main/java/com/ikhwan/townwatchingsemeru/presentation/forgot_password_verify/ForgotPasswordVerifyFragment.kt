...
import com.ikhwan.townwatchingsemeru.databinding.FragmentForgotPasswordVerifyBinding


class ForgotPasswordVerifyFragment : Fragment(), View.OnClickListener {

    private var _binding: FragmentForgotPasswordVerifyBinding? = null
    private val binding get() = _binding!!

    private val viewModel: ForgotPasswordVerifyViewModel by hiltNavGraphViewModels(R.id.nav_main)
    ...
    override fun onCreateView(
        ...
        _binding = FragmentForgotPasswordVerifyBinding.inflate(inflater, container, false)
        return binding.root
    }
            ...
            R.id.btn_resend_code -> {
                ShowActionAlertDialog(
                    ...
                    positiveButtonAction = {
                        viewModel.resendCode(ResendCodeBody(email))
    ...
    private fun verifyCode() {
        ...
        viewModel.verifyCode(verifyCodeBody)
            .observe(viewLifecycleOwner) { result ->
                when (result) {
                    is Resource.Error -> {
                        dialog.dismissDialog()
                    ...
                    is Resource.Success -> {
                        ...
                        Navigation.findNavController(requireView())
                            .navigate(
                                R.id.action_forgotPasswordVerifyFragment_to_resetPasswordFragment,
                                mBundle
                            )
                    }
                }
