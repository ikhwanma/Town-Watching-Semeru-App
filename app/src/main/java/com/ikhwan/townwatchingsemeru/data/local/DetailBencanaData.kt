...
data class DetailDeskripsiData(
    val id: Int,
    val desc: DeskripsiBencana
)

data class DeskripsiBencana(
    val desc: String,
    val img: Int
)

fun getDeskripsi(): List<DetailDeskripsiData> {
    return listOf(
        DetailDeskripsiData(
            1,
            DeskripsiBencana(
                "Bahaya erupsi gunungapi memiliki dua jenis bahaya " +
                        ...
                        "Institusi teknis terkait dengan kegunungapian adalah Pusat Vulkanologi dan Mitigasi Bencana Geologi " +
                        "(PVMBG). Informasi terkait gunungapi dapat dilihat pada laman berikut: " +
                        "http://www.vsi.esdm.go.id/ \n\nPVMBG juga memiliki produk aplikasi MAGMA Indonesia yang dapat diakses pada gawai, dengan basis Android dan IOS.",
                R.drawable.img_desc_erupsi
            )
        ),
        DetailDeskripsiData(
            2,
            DeskripsiBencana(
                ...
                R.drawable.img_desc_gempa_bumi
            )
        ),
        DetailDeskripsiData(
            3,
            DeskripsiBencana(
                ...
                R.drawable.img_desc_tanah_longsor
            )
        ),
        DetailDeskripsiData(
            4,
        ...
        DetailDeskripsiData(
            ...
            DeskripsiBencana(
                ...
                R.drawable.img_desc_angin_kencang
            )
        )
    )
}
    ...
    return listOf(
        ...
        DetailBencanaData(
            ...
            listOf(
                ...
                DetailBencanaDescription("Persiapkan dukungan logistik.", R.drawable.ic_food),
                DetailBencanaDescription(
                    "Simak informasi dari media mengenai informasi hujan dan kemungkinan tanah longsor.",
    ...
    return listOf(
        DetailBencanaData(
            ...
            listOf(
                ...
                DetailBencanaDescription(
                    "Memperhatikan perkembangan informasi dari pihak berwenang melalui televisi atau pengumuman dari pihak berwenang.",
                    R.drawable.ic_television
                ),
                DetailBencanaDescription(
        ...
        DetailBencanaData(
            ...
            listOf(
                DetailBencanaDescription(
                    "Segera periksa keselamatan orang-orang terdekat.",
                    R.drawable.ic_helping
                ),
                DetailBencanaDescription(
